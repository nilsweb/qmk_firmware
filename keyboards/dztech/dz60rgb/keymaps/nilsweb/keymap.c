...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[HYPER] = LAYOUT_ANSI(
      ...
      MO(HYPER2), _______, _______, UK_EURO, _______, _______, _______, UK_UUML, _______, UK_OUML, _______, _______, _______, _______,
	...
	[HYPER2] = LAYOUT_ANSI(
      ...
      _______, KC_P7, KC_P8, KC_P9, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
