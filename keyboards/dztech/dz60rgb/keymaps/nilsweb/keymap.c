...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[DEFAULT] = LAYOUT_ANSI(
      ...
      PK_LSUPER, KC_LALT, PK_LCOMMAND, KC_SPC, KC_LEAD, MO(FUNCTION), MO(KEYBOARD), CK_MNEMONIC
    ),
	...
	[HYPER] = LAYOUT_ANSI(
      ...
      _______, _______, _______, _______, _______, KC_BTN2, KC_BTN3, _______, CK_LTH, CK_GTH, _______, _______,
	...
	[HYPER2] = LAYOUT_ANSI(
      ...
      _______, KC_P1, KC_P2, KC_P3, KC_P0, _______, _______, _______, _______, CK_FATARR, _______, _______,
